"""
把歌词生成当做分类任务来做，使用2层lstm+1层dense，最后使用softmax。
"""
...
def map_words(cut_word_list):
    ...
    with open('./jjLin/word_to_index_word.txt', 'w', encoding='utf8') as w:
        w.write(word_to_index_json)
        w.close()
    with open('./jjLin/index_to_word_word.txt', 'w', encoding='utf8') as w:
...
def model_lstm(X_train, X_val, y_train, y_val, word_to_index):
    ...
    tensorboard = TensorBoard(log_dir='./tensorboard_log/jjLin/')
    # save best model.
    checkpoint = ModelCheckpoint(filepath='./jjLin/model_epoch50_2lstm_1dense_seq50_phrase_based_best.h5',
    ...
    model.save('./jjLin/model_epoch50_2lstm_1dense_seq50_phrase_based_best.h5')
...
if __name__ == '__main__':
    file_name = "../train_data/lyrics_jjLin.txt"
