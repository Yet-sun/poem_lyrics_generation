...
def generate(start, model, word2index, index2word, SEQ_LENGTH, generate_maxlen):
    ...
    while len(sentence) < generate_maxlen:
        ...
        next_word = index2word.get(next_index)
...
def eval_lyrics():
    ...
    :return:
    '''
    model_file = 'D:\mycode\Python_project\hzl_ML&DM\lyrics_generation\lstm_model\jjLin\model_epoch50_2lstm_1dense_seq50_phrase_based_best.h5'
    # model_file = './model_epoch50_2lstm_1dense_seq10_word_based_best.h5'
    word2index_file = './jjLin/word_to_index_word.txt'
    index2word_file = './jjLin/index_to_word_word.txt'
